...
{
	public static var akVersion:String = '1.0.0';
	...
	override function create()
	{
		...
		var bg:FlxSprite = new FlxSprite(-80).loadGraphic(Paths.image('ak_menu'));
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "AK v" + akVersion, 12);
